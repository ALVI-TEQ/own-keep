...
class FileDetailsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final document = documentAsyncValue?.value;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            Text(
              document?.summary.logicalFilename ?? l10n.s48_title,
              style: TextStyle(
            ...
            Text(
              document?.summary.mimeType ?? l10n.s48_subtitle,
              style: TextStyle(
        ...
        actions: [
          IconButton(
            ...
            onPressed: documentId == null
                ? null
                : () => context.push(
                    '/features/move-or-copy?id=${Uri.encodeQueryComponent(documentId!)}',
                  ),
          ),
        ],
      ),
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildDetailRow(
                          colors,
                          l10n.s48_type_label,
                          document?.summary.mimeType ?? l10n.s48_type,
                        ),
                        _buildDivider(colors),
                        _buildDetailRow(
                          colors,
                          l10n.s48_size_label,
                          document != null
                              ? '${document.assets.length} encrypted asset(s)'
                              : l10n.s48_size,
                        ),
                        _buildDivider(colors),
                        _buildDetailRow(
                          colors,
                          l10n.s48_added_label,
                          document?.summary.importedAt.toLocal().toString() ??
                              l10n.s48_added,
                        ),
                        _buildDivider(colors),
                        _buildDetailRow(
                          colors,
                          l10n.s48_modified_label,
                          l10n.s48_modified,
                        ),
                        _buildDivider(colors),
                        _buildDetailRow(
                          colors,
                          l10n.s48_location_label,
                          l10n.s48_location,
                        ),
                      ],
                    ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    document?.summary.integrityStatus ??
                                        l10n.s48_integrity,
                                    style: TextStyle(
                        ...
                        _buildDetailRow(
                          colors,
                          l10n.s48_local_id_label,
                          document?.summary.id ?? l10n.s48_local_id,
                        ),
                      ],
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: documentId == null
                          ? null
                          : () => context.push(
                              '/features/document-preview?id=${Uri.encodeQueryComponent(documentId!)}',
                            ),
                      icon: SvgPicture.asset(
  ...
  Widget _buildDivider(OwnKeepMainColorsTheme colors) {
    return Divider(color: colors.borderSoft, height: 1);
  }
}
